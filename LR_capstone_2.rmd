---
title: 'Predicting Divorce with the DS Test: a qualitative approach'
subtitle: "CYO - Data Science: Capstone"
author: "Luz E Rodriguez"
date: "October 2020"
output:
...
# temp <- tempfile()
# #temp2 <- tempfile()
# utils::download.file("https://archive.ics.uci.edu/ml/machine-learning-databases/00497/divorce.rar",temp, mode = "wb")
# #list.files(temp)
...
#divorce2 <- read.table(url("https://archive.ics.uci.edu/ml/machine-learning-databases/00497/divorce.rar"), sep = ";", header = TRUE)
rm(temp)
